...
const replStr = `<Card className={\`w-full lg:w-96 flex shrink-0 flex-col transition-all duration-300 \${selectedNode ? 'opacity-100 translate-x-0' : 'opacity-50 grayscale pointer-events-none'}\`}>`;
