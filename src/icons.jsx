// Icon component — inline SVG paths for ~40 lucide-style icons.
// Usage: <Icon name="folder" size={16} className="..." />
const ICON_PATHS = {
  // Generic
  github: <><path d="M9 19c-5 1.5-5-2.5-7-3"/><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.4 5.4 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/></>,
  ...
  cloud: <path d="M17.5 19a4.5 4.5 0 1 0-1.41-8.78A6 6 0 1 0 6 16.4"/>,
  ...
  blocks: <><rect width="7" height="7" x="14" y="3" rx="1"/><path d="M10 21V8a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v13c0 .6.4 1 1 1h5a1 1 0 0 0 1-1Zm0-9h7a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1h-7"/></>,
  ...
  // Programming languages — represented as colored badges, not real icons
};
