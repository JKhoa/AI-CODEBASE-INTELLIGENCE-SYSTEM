...
export async function runGeminiAnalysis(geminiKey, blobs, readmeContent = "", codeSnippet = "") {
  ...
  const prompt3 = `Bạn là chuyên gia giáo dục và đánh giá công nghệ. ĐỌC KỸ MÃ NGUỒN VÀ TÀI LIỆU SAU ĐỂ HIỂU CHÍNH XÁC NGHIỆP VỤ THỰC TẾ CỦA REPO:${readmeSnippet}${codeContext}\nDanh sách tệp:\n${fileList}\n\nTrả về JSON CHÍNH XÁC theo cấu trúc sau:\n{\n  "beginnerGuide": {"practicalExample":{"vi":"Ví dụ thực tế BÁM SÁT NGHIỆP VỤ TRONG MÃ NGUỒN (ví dụ: nếu code gọi API camera AI, hãy giải thích ứng dụng cảnh báo tài xế ngủ gật qua camera)","en":"string"},"simplePurpose":{"vi":"string","en":"string"},"coreValue":[{"vi":"string","en":"string"}]},\n  "contradictions": [{"type":"high|medium|low","vi":"string","en":"string"}],\n  "suitability": {"goodFor":[{"vi":"string","en":"string"}],"badFor":[{"vi":"string","en":"string"}]},\n  "categories": [{"id":"string","name":{"vi":"string","en":"string"},"qa":[{"q":"string","a":{"vi":"string","en":"string"},"icon":"target","tags":["string"]}]}]\n}`;
