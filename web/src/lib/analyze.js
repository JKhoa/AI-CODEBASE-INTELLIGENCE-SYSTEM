...
export async function runGeminiAnalysis(geminiKey, blobs, readmeContent = "", codeSnippet = "") {
  ...
  const prompt3 = `Bạn là chuyên gia phân tích kỹ thuật và giảng viên IT. ĐỌC KỸ MÃ NGUỒN VÀ TÀI LIỆU SAU ĐỂ HIỂU CHÍNH XÁC NGHIỆP VỤ THỰC TẾ CỦA REPO:${readmeSnippet}${codeContext}\nDanh sách tệp:\n${fileList}\n\nTrả về JSON CHÍNH XÁC theo cấu trúc sau:\n{\n  "beginnerGuide": {"practicalExample":{"vi":"Tùy thuộc vào mã nguồn (e-commerce, AI, blockchain, web...), hãy lấy 1 ví dụ cụ thể, đời thường, cực kỳ dễ hiểu nhưng thể hiện ĐÚNG logic kỹ thuật của repo này để người mới có thể hiểu ngay lập tức","en":"string"},"simplePurpose":{"vi":"Giải thích ngắn gọn, đi thẳng vào vấn đề trọng tâm repo này giải quyết bài toán gì","en":"string"},"coreValue":[{"vi":"string","en":"string"}]},\n  "contradictions": [{"type":"high|medium|low","vi":"string","en":"string"}],\n  "suitability": {"goodFor":[{"vi":"string","en":"string"}],"badFor":[{"vi":"string","en":"string"}]},\n  "categories": [{"id":"string","name":{"vi":"string","en":"string"},"qa":[{"q":"Câu hỏi phân tích chuyên sâu","a":{"vi":"Câu trả lời chi tiết, tường tận, mổ xẻ kỹ thuật","en":"string"},"icon":"target","tags":["string"]}]}]\n}`;
